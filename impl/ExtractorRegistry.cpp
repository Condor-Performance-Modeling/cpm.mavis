...
namespace mavis {
    ...
    const ExtractorIF::PtrType &ExtractorRegistry::getExtractor(const std::string &fname)
    {
        static const std::map<std::string, ExtractorIF::PtrType> EXTRACTOR_REGISTRY = {
            ...
            {Form_C2_sp_load_float_single::name,  std::make_shared<Extractor<Form_C2_sp_load_float_single>>()},
            {Form_C2_sp_load_float_double::name,  std::make_shared<Extractor<Form_C2_sp_load_float_double>>()},
            ...
            {Form_AndeStar_Custom_2_LEA::name,    std::make_shared<Extractor<Form_AndeStar_Custom_2_LEA>>()},
        };
